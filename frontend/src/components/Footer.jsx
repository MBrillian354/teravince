  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-3 flex justify-center items-center text-sm text-[#810000]">
        ...
        <Link to="/terms" className="hover:text-[#1B1717] mx-1 transition-all duration-150">
          Terms & Conditions
        </Link>
        <span className="mx-1">|</span>
        <Link to="/privacy" className="hover:text-[#1B1717] mx-1 transition-all duration-150">
          Privacy Policy
        </Link>
        <span className="mx-1">|</span>
        <Link to="/cookies" className="hover:text-[#1B1717] mx-1 transition-all duration-150">
          Cookie Policy
        </Link>
      </div>
    </footer>
